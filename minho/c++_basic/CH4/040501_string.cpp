...
int main()
{
    MyString str1("Hello Algorithm");
    MyString str2(str1);

    str1.println();
    str2.println();

    std::cout << "Location is : " <<str2.find(0,"Al") << "\n";

    MyString str3("Veeeeeeery looooooong");
    str3.reserve(50);

    std::cout << "Capacity : " << str3.capacity() << "\n";
    std::cout << "String length : " << str3.length() << "\n";
    str3.println();

    str1.insert(5, str3);
    str1.println();

    std::cout << "Compare : " << str3.compare(str1) <<"\n";
